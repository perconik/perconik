...
public class NodeTokenizerExample {
  public static void main(String[] args) throws Exception {
    ...
    NodeTokenizer<ASTNode> ct = NodeTokenizer.builder().collector(NodeCollectors.ofType(NodeType.JAVADOC, NodeType.QUALIFIED_NAME, NodeType.SIMPLE_NAME, NodeType.STRING_LITERAL)).transformer(new Function<ASTNode, String>() {
    ...
    }).tokenizer(Tokenizer.create(cf)).build();
