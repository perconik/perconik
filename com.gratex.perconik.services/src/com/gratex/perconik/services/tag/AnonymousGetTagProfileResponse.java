...
public class AnonymousGetTagProfileResponse {

    @XmlElement(name = "GetTagProfileResult")
    protected GetTagProfileResponse getTagProfileResult;
     ...
     * @return
     *     possible object is
     *     {@link GetTagProfileResponse }
     *     
     */
    public GetTagProfileResponse getGetTagProfileResult() {
     ...
     *     
     */
    public void setGetTagProfileResult(GetTagProfileResponse value) {
