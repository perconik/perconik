...
@XmlRootElement(name = "UnregisterEventListener")
public class UnregisterEventListener {

    @XmlElementRef(name = "eventId", namespace = "http://perconik.fiit.stuba.sk/ITM", type = JAXBElement.class, required = false)
