...
public class ObjectFactory {
    ...
    private final static QName _DataAttributeValues_QNAME = new QName("http://perconik.fiit.stuba.sk/ITM", "Values");
    ...
    public JAXBElement<ArrayOfanyType> createDataAttributeValues(ArrayOfanyType value) {
        return new JAXBElement<ArrayOfanyType>(_DataAttributeValues_QNAME, ArrayOfanyType.class, DataAttribute.class, value);
    }
    ...
    public JAXBElement<ArrayOfanyType> createArrayQueryValues(ArrayOfanyType value) {
        return new JAXBElement<ArrayOfanyType>(_DataAttributeValues_QNAME, ArrayOfanyType.class, ArrayQuery.class, value);
    }
