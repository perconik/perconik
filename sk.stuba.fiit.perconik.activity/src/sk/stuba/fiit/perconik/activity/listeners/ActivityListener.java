...
public abstract class ActivityListener extends RegularListener<ActivityListener> {
  ...
  private static final class ElasticsearchProxy extends SharedElasticsearchProxy implements Store<ActivityListener, Event> {
    ...
    private static final class IndexSource {
      ...
      private static Map<String, Object> mappings(final ActivityListener listener, final TransportClient client) {
        ...
        mappings.put(key("_meta"), meta(listener, client));
      ...
      private static Map<String, Object> meta(final ActivityListener listener, final TransportClient client) {
      ...
      static Map<String, Object> get(final ActivityListener listener, final TransportClient client, final String index, final String type) {
        ...
        source.put(key("mappings", type), mappings(listener, client));
